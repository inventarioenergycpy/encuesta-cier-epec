...
pptx_2025 = os.path.join(BASE_DIR, "data", "raw", "2025", "Presentacion Individual 2025 - EPEC-AR.pptx")

def extract_pptx_slides(pptx_file, out_txt):
...
if os.path.exists(pptx_2025):
    extract_pptx_slides(pptx_2025, os.path.join(BASE_DIR, "data", "processed", "pptx_slides_2025.txt"))
